...
const FIELD_DEFS: Array<{
  ...
  },
  {
    ...
    description: 'HTTPS URL of a shell script run on first boot. Each install receives a freshly generated SYNC_API_TOKEN plus BASE_DOMAIN, SYNC_API_DOMAIN, and SYNC_API_URL. Leave blank to use the platform default.',
    testable: true,
  },
  {
